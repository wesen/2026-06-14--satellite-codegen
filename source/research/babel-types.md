...
- `typeAnnotation`: `TypeAnnotation | TSTypeAnnotation | Noop` (default: `null`, excluded from 
builder function)

Aliases: [`Standardized`](#standardized), [`FunctionParameter`](#functionparameter), 
[`Pattern`](#pattern), [`PatternLike`](#patternlike), [`LVal`](#lval)
...
See also `t.isArrowFunctionExpression(node, opts)` and `t.assertArrowFunctionExpression(node, 
opts)`.
...
- `predicate`: `DeclaredPredicate | InferredPredicate` (default: `null`, excluded from builder 
function)
- `returnType`: `TypeAnnotation | TSTypeAnnotation | Noop` (default: `null`, excluded from builder 
function)
- `typeParameters`: `TypeParameterDeclaration | TSTypeParameterDeclaration | Noop` (default: 
`null`, excluded from builder function)

Aliases: [`Standardized`](#standardized), [`Scopable`](#scopable), [`Function`](#function), 
[`BlockParent`](#blockparent), [`FunctionParent`](#functionparent), [`Expression`](#expression), 
[`Pureish`](#pureish)
...
- `left`: `Identifier | ObjectPattern | ArrayPattern | MemberExpression | TSAsExpression | 
TSSatisfiesExpression | TSTypeAssertion | TSNonNullExpression` (required)
- `right`: `Expression` (required)
- `decorators`: `Decorator[]` (default: `null`, excluded from builder function)
- `optional`: `boolean` (default: `null`, excluded from builder function)
- `typeAnnotation`: `TypeAnnotation | TSTypeAnnotation | Noop` (default: `null`, excluded from 
...
Aliases: [`Standardized`](#standardized), [`Expression`](#expression), [`Pureish`](#pureish), 
[`Literal`](#literal), [`Immutable`](#immutable)
...
[`Terminatorless`](#terminatorless), [`CompletionStatement`](#completionstatement)
...
- `accessibility`: `"public" | "private" | "protected"` (default: `null`, excluded from builder 
function)
...
ClassAccessorProperty | TSDeclareMethod | TSIndexSignature | StaticBlock)[]` (required)
...
- `abstract`: `boolean` (default: `null`, excluded from builder function)
- `declare`: `boolean` (default: `null`, excluded from builder function)
- `implements`: `(TSExpressionWithTypeArguments | ClassImplements)[]` (default: `null`, excluded 
from builder function)
- `mixins`: `InterfaceExtends` (default: `null`, excluded from builder function)
- `superTypeParameters`: `TypeParameterInstantiation | TSTypeParameterInstantiation` (default: 
`null`, excluded from builder function)
- `typeParameters`: `TypeParameterDeclaration | TSTypeParameterDeclaration | Noop` (default: 
`null`, excluded from builder function)

Aliases: [`Standardized`](#standardized), [`Scopable`](#scopable), [`Class`](#class), 
...
Aliases: [`Standardized`](#standardized), [`Function`](#function), [`Scopable`](#scopable), 
[`BlockParent`](#blockparent), [`FunctionParent`](#functionparent), [`Method`](#method)
...
Aliases: [`Flow`](#flow), [`FlowDeclaration`](#flowdeclaration), [`Statement`](#statement), 
...
See also `t.isDeclareExportAllDeclaration(node, opts)` and 
`t.assertDeclareExportAllDeclaration(node, opts)`.
...
See also `t.isDeclareExportDeclaration(node, opts)` and `t.assertDeclareExportDeclaration(node, 
opts)`.
...
Aliases: [`Standardized`](#standardized), [`Statement`](#statement), [`BlockParent`](#blockparent), 
[`Loop`](#loop), [`While`](#while), [`Scopable`](#scopable)
...
[`ImportOrExportDeclaration`](#importorexportdeclaration), [`ExportDeclaration`](#exportdeclaration)
...
See also `t.isExportDefaultDeclaration(node, opts)` and `t.assertExportDefaultDeclaration(node, 
opts)`.
...
See also `t.isExportNamespaceSpecifier(node, opts)` and `t.assertExportNamespaceSpecifier(node, 
opts)`.
...
Aliases: [`Standardized`](#standardized), [`Scopable`](#scopable), [`Statement`](#statement), 
[`For`](#for), [`BlockParent`](#blockparent), [`Loop`](#loop), [`ForXStatement`](#forxstatement)
...
Aliases: [`Standardized`](#standardized), [`Scopable`](#scopable), [`Statement`](#statement), 
[`For`](#for), [`BlockParent`](#blockparent), [`Loop`](#loop)
...
Aliases: [`Standardized`](#standardized), [`Scopable`](#scopable), [`Function`](#function), 
[`BlockParent`](#blockparent), [`FunctionParent`](#functionparent), [`Statement`](#statement), 
[`Pureish`](#pureish), [`Declaration`](#declaration)
...
Aliases: [`Standardized`](#standardized), [`Expression`](#expression), 
[`FunctionParameter`](#functionparameter), [`PatternLike`](#patternlike), [`LVal`](#lval), 
...
See also `t.isImportNamespaceSpecifier(node, opts)` and `t.assertImportNamespaceSpecifier(node, 
opts)`.
...
See also `t.isInterfaceTypeAnnotation(node, opts)` and `t.assertInterfaceTypeAnnotation(node, 
opts)`.
...
See also `t.isIntersectionTypeAnnotation(node, opts)` and `t.assertIntersectionTypeAnnotation(node, 
opts)`.
...
See also `t.isNullLiteralTypeAnnotation(node, opts)` and `t.assertNullLiteralTypeAnnotation(node, 
opts)`.
...
`t.assertNumberLiteralTypeAnnotation(node, opts)`.
...
Aliases: [`Standardized`](#standardized), [`UserWhitespacable`](#userwhitespacable), 
[`Function`](#function), [`Scopable`](#scopable), [`BlockParent`](#blockparent), 
[`FunctionParent`](#functionparent), [`Method`](#method), [`ObjectMember`](#objectmember)
...
Aliases: [`Standardized`](#standardized), [`UserWhitespacable`](#userwhitespacable), 
[`Property`](#property), [`ObjectMember`](#objectmember)
...
See also `t.isObjectTypeSpreadProperty(node, opts)` and `t.assertObjectTypeSpreadProperty(node, 
opts)`.
...
See also `t.isOptionalIndexedAccessType(node, opts)` and `t.assertOptionalIndexedAccessType(node, 
opts)`.
...
See also `t.isOptionalMemberExpression(node, opts)` and `t.assertOptionalMemberExpression(node, 
opts)`.
...
See also `t.isParenthesizedExpression(node, opts)` and `t.assertParenthesizedExpression(node, 
opts)`.
...
See also `t.isPipelinePrimaryTopicReference(node, opts)` and 
`t.assertPipelinePrimaryTopicReference(node, opts)`.
...
See also `t.isPipelineTopicExpression(node, opts)` and `t.assertPipelineTopicExpression(node, 
opts)`.
...
- `expectedNode`: `"Identifier" | "StringLiteral" | "Expression" | "Statement" | "Declaration" | 
"BlockStatement" | "ClassBody" | "Pattern"` (required)
...
See also `t.isQualifiedTypeIdentifier(node, opts)` and `t.assertQualifiedTypeIdentifier(node, 
opts)`.
...
- `argument`: `Identifier | ArrayPattern | ObjectPattern | MemberExpression | TSAsExpression | 
TSSatisfiesExpression | TSTypeAssertion | TSNonNullExpression | RestElement | AssignmentPattern` 
(required)
- `decorators`: `Decorator[]` (default: `null`, excluded from builder function)
- `optional`: `boolean` (default: `null`, excluded from builder function)
- `typeAnnotation`: `TypeAnnotation | TSTypeAnnotation | Noop` (default: `null`, excluded from 
...
Aliases: [`Standardized`](#standardized), [`FunctionParameter`](#functionparameter), 
[`PatternLike`](#patternlike), [`LVal`](#lval)
...
Aliases: [`TypeScript`](#typescript), [`Expression`](#expression), [`LVal`](#lval), 
[`PatternLike`](#patternlike)
...
See also `t.isTSCallSignatureDeclaration(node, opts)` and `t.assertTSCallSignatureDeclaration(node, 
opts)`.
...
See also `t.isTSConstructSignatureDeclaration(node, opts)` and 
`t.assertTSConstructSignatureDeclaration(node, opts)`.
...
- `generator`: `boolean` (default: `false`, excluded from builder function)
- `kind`: `"get" | "set" | "method" | "constructor"` (default: `'method'`, excluded from builder 
function)
- `optional`: `boolean` (default: `null`, excluded from builder function)
- `override`: `boolean` (default: `false`, excluded from builder function)
...
See also `t.isTSExpressionWithTypeArguments(node, opts)` and 
`t.assertTSExpressionWithTypeArguments(node, opts)`.
...
See also `t.isTSExternalModuleReference(node, opts)` and `t.assertTSExternalModuleReference(node, 
opts)`.
...
See also `t.isTSImportEqualsDeclaration(node, opts)` and `t.assertTSImportEqualsDeclaration(node, 
opts)`.
...
See also `t.isTSInstantiationExpression(node, opts)` and `t.assertTSInstantiationExpression(node, 
opts)`.
...
- `literal`: `NumericLiteral | StringLiteral | BooleanLiteral | BigIntLiteral | TemplateLiteral | 
UnaryExpression` (required)
...
Aliases: [`TypeScript`](#typescript), [`Scopable`](#scopable), [`Block`](#block), 
[`BlockParent`](#blockparent), [`FunctionParent`](#functionparent)
...
See also `t.isTSNamespaceExportDeclaration(node, opts)` and 
`t.assertTSNamespaceExportDeclaration(node, opts)`.
...
See also `t.isTSTypeParameterDeclaration(node, opts)` and `t.assertTSTypeParameterDeclaration(node, 
opts)`.
...
See also `t.isTSTypeParameterInstantiation(node, opts)` and 
`t.assertTSTypeParameterInstantiation(node, opts)`.
...
See also `t.isTaggedTemplateExpression(node, opts)` and `t.assertTaggedTemplateExpression(node, 
opts)`.
...
See also `t.isTypeParameterDeclaration(node, opts)` and `t.assertTypeParameterDeclaration(node, 
opts)`.
...
See also `t.isTypeParameterInstantiation(node, opts)` and `t.assertTypeParameterInstantiation(node, 
opts)`.
...
Aliases: [`Pattern`](#pattern), [`PatternLike`](#patternlike), 
...
[LexicalEnvironment](https://tc39.es/ecma262/#table-additional-state-components-for-ecmascript-code-
execution-contexts). In other words, they define the scope of `let` and `const` declarations.
...
A statement that indicates the [completion 
records](https://tc39.es/ecma262/#sec-completion-record-specification-type). In other words, they 
define the control flow of the program, such as when should a loop break or an action throws 
critical errors.
...
A cover of [ForStatement](https://tc39.es/ecma262/#sec-for-statement) s and 
[ForXStatement](#forxstatement) s.
...
A cover of [ForInStatements and 
ForOfStatements](https://tc39.es/ecma262/#sec-for-in-and-for-of-statements).
...
A cover of functions and [method](#method) s, the must have `body` and `params`. Note: `Function` 
is different to `FunctionParent`. For example, a `StaticBlock` is a `FunctionParent` but not 
`Function`.
...
A cover of function parameters. They are the elements of 
[FormalParameterList](https://tc39.es/ecma262/#prod-FormalParameterList).
...
A cover of AST nodes that start an execution context with new 
[VariableEnvironment](https://tc39.es/ecma262/#table-additional-state-components-for-ecmascript-code
-execution-contexts). In other words, they define the scope of `var` declarations. FunctionParent 
did not include `Program` since Babel 7.
...
A cover of immutable objects and JSX elements. An object is 
[immutable](https://tc39.es/ecma262/#immutable-prototype-exotic-object) if no other properties can 
be defined once created.
...
A cover of left hand side expressions used in the `left` of assignment expressions and 
[ForXStatement](#forxstatement) s.
...
A cover of [Literal](https://tc39.es/ecma262/#sec-primary-expression-literals) s, [Regular 
Expression Literal](https://tc39.es/ecma262/#sec-primary-expression-regular-expression-literals) s 
and [Template Literal](https://tc39.es/ecma262/#sec-template-literals) s.
...
> caution
> 
> Deprecated, use [`ImportOrExportDeclaration`](#importorexportdeclaration) instead. Check out [PR 
#15266](https://github.com/babel/babel/pull/15266#issue-1492649843) for migration notes.
...
A cover of import and export specifiers. Note: It is *not* the 
[ModuleSpecifier](https://tc39.es/ecma262/#prod-ModuleSpecifier) defined in the spec.
...
A cover of AST nodes which do not have side-effects. In other words, there is no observable 
behaviour changes if they are evaluated more than once.
...
A cover of AST nodes whose semantic will change when a line terminator is inserted between the 
